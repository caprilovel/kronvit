...
def get_args_parser():
    ...
    # Dataset parameters
    parser.add_argument('--data-path', default='/local/storage/ding/imagenet2012', type=str,
                        help='dataset path')
    ...
    parser.add_argument('--kron', action='store_true', default=False, help='kron decomposition')
