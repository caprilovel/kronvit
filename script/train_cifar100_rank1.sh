...
torchrun --nproc_per_node=$GPU_NUM \
     ...
     --warmup-lr 1e-3\
     --min-lr 1e-4\
     --output_dir /home/zhu.3723/kronvit/output/cifar100_kron30/deit_tiny_patch16_224_1/ \
     --kron_rank 1\
     --shape_bias 3\
     # --finetune /home/zhu.3723/kronvit/output/cifar100_kron30/deit_tiny_patch16_224_1/best_checkpoint.pth \
